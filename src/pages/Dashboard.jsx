...
const Dashboard = () => {
  ...
  const handleGoToDashboard = () => {
    // This will navigate the user to the "/dashboard" route
          ...
          {appointments.length === 0 ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold text-slate-700 border-b pb-3">
                  Upcoming
                </h2>
                  ...
                  upcomingAppointments.map((appt) => (
                    ...
                    >
                      <div className="flex justify-between items-start">
                        ...
                        <span
                          className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ring-1 ring-inset ${getStatusStyles(
                            appt.status
                          )}`}
                        >
                          {appt.status}
              ...
              <div className="space-y-6">
                ...
                {pastAppointments.length > 0 ? (
                  pastAppointments.map((appt) => (
                    <div
                      key={appt._id}
                      className="bg-white p-6 rounded-lg shadow-sm border border-slate-200 opacity-80"
                    >
                      <div className="flex justify-between items-start">
                        <div>
